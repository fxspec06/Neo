	...
	components: [
		{
			...
			components: [
				...
				{kind: "enyo.Control", name: "title", classes: "notification-bezel-title", allowHtml:true},
				{kind: "enyo.Control", name: "message", classes: "notification-bezel-message", allowHtml:true}
			],
			ontap: "notifTap"
		},
